...
dataFolder      = fullfile('C:\Users\Jespe\OneDrive\Skrivebord\TPL\testing');              % <--- EDIT THE DATA FOLDER HERE
% subDirectories  = dir(dataFolder);
FileList  = dir(dataFolder);
% searchString    = 'TPL_v*-1_0';                                                                     % <--- AND THE FILE NAME
dataFolderOut   = fullfile('C:\Users\Jespe\OneDrive\Skrivebord\TPL\HGF analysis');                              % <--- EDIT OUTPUT FOLDER

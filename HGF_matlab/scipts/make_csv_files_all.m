function make_csv_files_all(nSubjects)
...
dataFolderOut   = fullfile('C:\Users\Jespe\OneDrive\Skrivebord\TPL\csv');
...
%         end
        ...
        q = FileList(subLoop).name
        q = q(1:end-3)
        s1 = append(q, "csv");
        s2 = append(dataFolderOut, "\")
        name = append(s2, s1);

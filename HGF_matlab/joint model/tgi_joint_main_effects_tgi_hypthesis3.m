...
function [logp, yhat, res] = tgi_joint_main_effects_tgi_hypthesis3(r, infStates, ptrans)
...
trial = trial';
trial(r.irr2) = [];
logrt = be0+be1.*rts+be2.*stim(:,3)+be3.*stim(:,2)+be4.*envi+be5.*sa3hat+be6.*stim(:,2).*envi+be7.*stim(:,3).*envi+be8.*stim(:,2).*sa3hat+be9.*stim(:,3).*sa3hat;

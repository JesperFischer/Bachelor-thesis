...
function [logp, yhat, res] = tgi_joint_main_effects_sa2hat(r, infStates, ptrans)
...
trial = trial';
trial(r.irr2) = [];
logrt = be0+be1.*rts+be2.*stim(:,3)+be3.*stim(:,4)+be4.*sa2hat+be5.*stim(:,4).*sa2hat+be6.*stim(:,3).*sa2hat;

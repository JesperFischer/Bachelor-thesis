...
function [logp, yhat, res] = cwt_joint(r, infStates, ptrans)
...
logrt = be0+be1.*bernv+be2.*stim(:,2)+be3.*stim(:,3)+be4.*stim(:,4)+be5.*stim(:,2).*bernv+be6.*stim(:,3).*bernv+be7.*stim(:,4).*bernv;

...
function [logp, yhat, res] = tgi_joint_main_effects_sa23hat(r, infStates, ptrans)
...
trial = trial';
trial(r.irr2) = [];
logrt = be0+be1.*trial+be2.*rts+be3.*stim(:,3)+be4.*stim(:,4)+be5.*sa2hat+be6.*sa3hat+be7.*stim(:,2).*sa2hat+be8.*stim(:,3).*sa2hat+be9.*stim(:,4).*sa2hat+be10.*stim(:,2).*sa3hat+be11.*stim(:,3).*sa3hat+be12.*stim(:,4).*sa3hat;

...
function [logp, yhat, res] = tgi_joint_main_effects_alles(r, infStates, ptrans)
...
trial = trial';
trial(r.irr2) = [];
logrt = be0+be1.*trial+be2.*rts+be3.*stim(:,3)+be4.*stim(:,4)+be5.*pv+be6.*mu3hat+be7.*mu3hat.*pv+be8.*stim(:,2).*mu3hat.*pv+be9.*stim(:,3).*mu3hat.*pv+be10.*stim(:,4).*mu3hat.*pv;

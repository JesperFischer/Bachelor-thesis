function c = tapas_hgf_binary_pu_tgi_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
expectedLength = 3*c.n_levels+2*(c.n_levels-1)+6;
...
c.prc_fun = @tapas_hgf_binary_pu_tgi_psi_la;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_hgf_binary_pu_tgi_transp;
